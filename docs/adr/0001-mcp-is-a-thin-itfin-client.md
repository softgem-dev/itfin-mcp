...
- The server enforces only rules ITFin itself publishes (closed day, minimum comment length, the leave reasons and availability ITFin's request form uses). It adds no business rules such as daily hour norms or rounding.
